...
// compresses chromatic differences and adds chroma-weighted density depth.
// It is an explicit look control, not a claimed reconstruction of interimage
// chemistry. Its internal amount zero is a strict calibrated bypass; public
// interfaces expose the signed trim mapped by amount_from_trim().
